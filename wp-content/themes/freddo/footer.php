				...
				<div class="site-copy-down">
					<div class="site-info">
						<?php if ($copyrightText || is_customize_preview()): ?>
							<span class="custom"><?php echo wp_kses($copyrightText, freddo_allowed_html()); ?></span>
						<?php endif; ?>
						<span class="sep"> | </span>
						<?php 
							/* translators: 1: theme name, 2: theme developer */
							printf( esc_html__( 'WordPress Theme: %1$s by %2$s.', 'freddo' ), '<a target="_blank" href="https://crestaproject.com/downloads/freddo/" rel="nofollow" title="Freddo Theme">Freddo</a>', 'CrestaProject' );
						?>
					</div><!-- .site-info -->
